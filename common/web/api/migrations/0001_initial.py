    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('type', models.CharField(default='connect4', max_length=10)),
                ...
                ('winner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='winner', to='api.player')),
            ],
        ),
        migrations.CreateModel(
            name='Friends',
