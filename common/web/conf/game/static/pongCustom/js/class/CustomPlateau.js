	...
	async createPlateau() {
		return new Promise(async (resolve, reject) => {
			...
			this.plateauMaterial = new THREE.MeshPhysicalMaterial({
				color: this.plateau.color, transparent: true, opacity: plateauMaterial.opacity, wireframe: false, side: THREE.FrontSide, roughness: 0.7, metalness: 0.7, clearcoat: 1.0,
